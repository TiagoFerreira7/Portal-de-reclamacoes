...
import { FaEnvelope, FaUser, FaTag, FaFileAlt, FaRegCalendarAlt, FaPaperclip, FaQuestionCircle } from 'react-icons/fa';
  ...
  <div className="mt-4">
    {files.map((f, index) => (
      <div key={index} className="mb-2 flex items-center">
        <p className="mr-2">Ficheiro: {f.name}</p>
        ...
        >
         <p className="font-semibold flex items-center">
          Perguntas Frequentes <FaQuestionCircle className="ml-2 text-gray-500" />
          </p>
